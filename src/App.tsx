        ...
        <div className="border-t border-white/10">
          ...
          <div className="border-b border-white/10">
            <div className="max-w-6xl mx-auto px-4 sm:px-8 py-3 sm:py-4 flex items-center justify-between">
              ...
              {/* Only show on sm+ */}
              <div className="hidden sm:flex items-center gap-2 text-xs text-zinc-600 border border-white/[0.07] px-3 py-1.5">
          ...
          <div className="max-w-6xl mx-auto">
            {/* Step 01 — Seed Phrase */}
            <div className="border-b border-white/10">
              {/* Sidebar label — hidden on mobile, shown as inline pill instead */}
              <div className="block sm:hidden px-4 pt-6 pb-2">
                <span className="text-xs text-zinc-600 uppercase tracking-widest font-medium">Step 01 · Recovery Phrase</span>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-12">
                {/* Sidebar — desktop only */}
                <div className="hidden sm:block sm:col-span-3 border-r border-white/10 p-8">
                ...
                <div className="sm:col-span-9 p-4 sm:p-8">
                  <SeedPhraseGenerator
                    chain={selectedChain}
                    mnemonic={mnemonic}
            ...
            {mnemonic && (
              <div>
                <div className="block sm:hidden px-4 pt-6 pb-2">
                  <span className="text-xs text-zinc-600 uppercase tracking-widest font-medium">Step 02 · Derived Wallets</span>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-12">
                  <div className="hidden sm:block sm:col-span-3 border-r border-white/10 p-8">
...
function LandingView({
  ...
  return (
    <>
      ...
      <div className="border-b border-white/10">
        <div className="max-w-6xl mx-auto">
          {/* Desktop: grid with side columns. Mobile: simple padding */}
          <div className="grid grid-cols-1 sm:grid-cols-12 min-h-[320px] sm:min-h-[420px]">
            <div className="hidden sm:block sm:col-span-1 border-r border-white/10 relative">
              <div className="absolute top-8 left-1/2 -translate-x-1/2 w-px h-full bg-gradient-to-b from-white/20 to-transparent" />
            </div>
            <div className="sm:col-span-10 px-4 sm:px-12 py-12 sm:py-20 sm:border-r border-white/10 flex flex-col justify-center">
              <div className="inline-flex items-center gap-2 mb-6 sm:mb-8">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                <span className="text-xs sm:text-sm text-zinc-500 tracking-wide">Non-custodial · Open source · Local</span>
              </div>
              ...
              <p className="text-base sm:text-xl text-zinc-400 mt-4 sm:mt-6 max-w-xl leading-relaxed">
              ...
              {hasMnemonic && (
                <div className="mt-6 sm:mt-8 flex items-start sm:items-center gap-3 sm:gap-4 border border-emerald-500/20 bg-emerald-500/5 px-4 sm:px-5 py-3 sm:py-4 max-w-xl">
                  <svg className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5 sm:mt-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="border-b border-white/10">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-12">
            <div className="hidden sm:block sm:col-span-1 border-r border-white/10" />
            <div className="sm:col-span-10 sm:border-r border-white/10 px-4 sm:px-12 py-8 sm:py-10">
              <p className="text-xs sm:text-sm text-zinc-600 uppercase tracking-widest mb-4 sm:mb-6 font-medium">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <ChainCard
                  ...
                  logo={
                    <svg viewBox="0 0 397.7 311.7" className="w-9 h-9 sm:w-10 sm:h-10">
                ...
                <ChainCard
                  ...
                  logo={
                    <svg viewBox="0 0 32 32" className="w-9 h-9 sm:w-10 sm:h-10">
                      <g fill="#627EEA">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-white/10">
          {[
            ...
            <div key={i} className="px-4 sm:px-10 py-6 sm:py-8">
              <p className="text-sm sm:text-base font-semibold text-white">{item.label}</p>
              <p className="text-xs sm:text-sm text-zinc-500 mt-1 sm:mt-1.5 leading-relaxed">{item.desc}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="relative flex items-center sm:items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-baseline gap-2">
            <span className="text-lg sm:text-xl font-bold text-white">{name}</span>
            <span className="text-xs text-zinc-600 font-mono">{ticker}</span>
          </div>
          <p className="text-xs sm:text-sm text-zinc-500 mt-1 leading-relaxed">{desc}</p>
          <div className="flex items-center gap-1.5 mt-3 sm:mt-4 text-sm font-medium" style={{ color }}>
